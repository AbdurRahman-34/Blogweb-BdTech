                ...
                <div>
                    {
                       popularBlogs.slice(0, 5).map(blog => 
                        ...
                        <h4 className='font-medium  mt-3'>{blog.title}</h4>
                        <Link to="/" className='text-base hover:text-blue-500 inline-flex items-center py-1'>Read now<FaArrowRight className='mt-1 ml-2' /></Link>
                        </div>
                        ) 
                    }
                </div>
